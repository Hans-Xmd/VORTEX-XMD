let handler = async (m, { conn, isROwner, text }) => {
  ...
  if (!message) throw '*ENTER THE MESSAGE YOU WANT TO BROADCAST. 2025 VORTEX-XMD BOT*';
        ...
        let mediaOptions = {
          ...
          contextInfo: {
            ...
            forwardedNewsletterMessageInfo: {
              ...
              newsletterName: 'VORTEX-XMD DIRECT MESSAGE 💖🦄',
              serverMessageId: 143
            }
          }
        };
