// Add Member Command Script for Vortex Xmd Bot
// This script allows group admins to add members using the command format: add 255756530143
...
let handler = async (m, { conn, args }) => {
  try {
    ...
    m.reply(`Vortex Xmd> bot : Successfully added @${target.split('@')[0]}`, null, { mentions: [target] });
