...
let handler = async (m, { conn, text, usedPrefix, command }) => { 
  ...
  let url = 'https://github.com/Hans-Xmd/VORTEX-XMD'
  let murl = 'https://whatsapp.com/channel/0029VasiOoR3bbUw5aV4qB31'
  let img = 'https://i.imgur.com/MBGZgNz.jpeg'
  
  let con = {
    key: {
      fromMe: false,
      participant: `${m.sender.split`@`[0]}@s.whatsapp.net`,
      ...(m.chat ? { remoteJid: '255760774888@s.whatsapp.net' } : {}),
    },
    message: {
      contactMessage: {
        displayName: `${name}`,
