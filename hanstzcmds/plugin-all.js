...
let handler = async (m, { conn }) => {
  ...
  let sourceUrl = 'https://github.com/Hans-Xmd/VORTEX-XMD/EXTERNAL-PLUGINS';

  // Send reply with external ad style
  await conn.sendMessage(m.chat, {
    text: '*VORTEX-XMD EXTERNAL PLUGINS*\n\nhttps://github.com/Hans-Xmd/VORTEX-XMD/EXTERNAL-PLUGINS',
    contextInfo: {
